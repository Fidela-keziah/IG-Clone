...
class ProfileTestClass(TestCase):
    ...
    '''
    def setUp(self):
        self.user = User.objects.create(id =1,username='fidela')
        self.profile = Profile(firstname = 'fidie',lastname = 'Keziah,profile_photo = 'image.jpeg',bio = 'beautiful' date = '12.2.2121' user = self.user)
...
class ImageTestClass(TestCase):
    ...
    '''
    def setUp(self):
        self.image = Image(image ='image.jpeg', image_name='test', image_caption='this is a test image',date='12.9.2019')
